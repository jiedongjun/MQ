...
public class TOPReceive2 {

	//连接账号
    private String userName = "jiedongjun";
    //连接密码
    private String password = "199218";
    //连接地址
    ...
    //消费者
    private MessageConsumer consumer; //创建消费者
    
    public static void main(String[] args) {
    	TOPReceive2 receive = new TOPReceive2();
    	receive.start();
    }
